 ...
 */
package funcionesConnect4;

/**
 *
 * @author rjcastellanos 
 */
import java.util.Scanner;
public class FuncionesConnect4 {
        ...
        while(GameRunning)
        {
            ...
            switch(opMenuInicio)
            {
                ...
                case 2:
                {
                    ...
                    while(InGameActive)
                    {
                        //aqui va la logica del juego PORQUE AQUI INFICA QUE SI EXISTE EL USUARIO
                    }
                    break;
                }
...
public static void InGameLogic(String OnlineUser)
{
    ...
    {
        System.out.println("Ingrese El Numero De La Opcion Deseada");
        System.out.println("1 - Jugar Connect 4");
